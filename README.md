...
* [UFADE](https://github.com/prosch88/UFADE) ⭐ 548 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Extract files from Apple devices on Windows, Linux and MacOS. Mostly a wrapper for pymobiledevice3. Creates iTunes-style backups and "advanced logical backups"
...
* [floss](https://github.com/fireeye/flare-floss) ⭐ 4,158 | 🐛 119 | 🌐 Python | 📅 2026-09-22 - Static analysis tool to automatically deobfuscate strings from malware binaries
...
* [MemProcFS](https://github.com/ufrisk/MemProcFS) ⭐ 4,350 | 🐛 7 | 🌐 C | 📅 2026-09-14 - An easy and convenient way of accessing physical memory as files a virtual file system.
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,825 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
...
* [hindsight](https://github.com/obsidianforensics/hindsight) ⭐ 1,514 | 🐛 35 | 🌐 Python | 📅 2026-09-25 - Internet history forensics for Google Chrome/Chromium
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,369 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images.
...
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,638 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA is a tool used mainly to find metadata and hidden information in the documents
...
* [OSINT](https://github.com/jivoi/awesome-osint) ⭐ 29,716 | 🐛 5 | 📅 2026-09-09
...
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,194 | 🐛 14 | 📅 2026-09-05
* [YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,273 | 🐛 1 | 📅 2026-06-15
* [Social Engineering](https://github.com/v2-dev/awesome-social-engineering) ⭐ 4,270 | 🐛 11 | 📅 2023-04-05
