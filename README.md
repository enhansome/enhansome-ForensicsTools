...
* [UFADE](https://github.com/prosch88/UFADE) ⭐ 548 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Extract files from Apple devices on Windows, Linux and MacOS. Mostly a wrapper for pymobiledevice3. Creates iTunes-style backups and "advanced logical backups"
...
* [MacOs Collector](https://github.com/LETHAL-FORENSICS/macos-collector) ⭐ 51 | 🐛 0 | 🌐 Shell | 📅 2026-09-13 - Shell script utilized to collect macOS Forensic Artifacts from a compromised macOS endpoint
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,821 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-23 - is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,367 | 🐛 95 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images.
...
* [OSINT](https://github.com/jivoi/awesome-osint) ⭐ 29,705 | 🐛 6 | 📅 2026-09-09
...
* [Awesome Forensics](https://github.com/cugu/awesome-forensics) ⭐ 5,193 | 🐛 14 | 📅 2026-09-05
* [YARA](https://github.com/InQuest/awesome-yara) ⭐ 4,273 | 🐛 1 | 📅 2026-06-15
