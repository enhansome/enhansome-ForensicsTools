...
* [UFADE](https://github.com/prosch88/UFADE) ⭐ 505 | 🐛 3 | 🌐 Python | 📅 2026-07-29 - Extract files from Apple devices on Windows, Linux and MacOS. Mostly a wrapper for pymobiledevice3. Creates iTunes-style backups and "advanced logical backups"
...
* [floss](https://github.com/fireeye/flare-floss) ⭐ 4,119 | 🐛 121 | 🌐 Python | 📅 2026-08-11 - Static analysis tool to automatically deobfuscate strings from malware binaries
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,404 | 🐛 70 | 🌐 C++ | 📅 2026-08-11 - Extracts informations like email adresses, creditscard numbers and histrograms of disk images
...
* [APFS Fuse](https://github.com/sgan81/apfs-fuse) ⭐ 2,131 | 🐛 124 | 🌐 C++ | 📅 2024-08-13 - is a read-only FUSE driver for the new Apple File System
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,590 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-10 - is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* [Andriller](https://github.com/den4uk/andriller) ⭐ 1,594 | 🐛 11 | 🌐 Python | 📅 2022-06-27 - is software utility with a collection of forensic tools for smartphones. It performs read-only, forensically sound, non-destructive acquisition from Android devices
...
* [unfurl](https://github.com/obsidianforensics/unfurl) ⭐ 759 | 🐛 33 | 🌐 Python | 📅 2026-08-12 - Extract and visualize data from URLs
...
* [Zsteg](https://github.com/zed-0xff/zsteg) ⭐ 1,606 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - A steganographic coder for WAV files
* [Steghide](https://github.com/StefanoDeVuono/steghide) ⭐ 767 | 🐛 4 | 🌐 C++ | 📅 2024-02-20 - is a steganography program that hides data in various kinds of image and audio files
* [Foremost](https://github.com/korczis/foremost) ⭐ 370 | 🐛 6 | 🌐 C | 📅 2023-05-26 - is a program to recover files based on their headers and footers
...
* [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,612 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA is a tool used mainly to find metadata and hidden information in the documents
...
* [Social Engineering](https://github.com/v2-dev/awesome-social-engineering) ⭐ 4,217 | 🐛 9 | 📅 2023-04-05
