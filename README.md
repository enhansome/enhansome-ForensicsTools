...
* [floss](https://github.com/fireeye/flare-floss) ⭐ 4,145 | 🐛 113 | 🌐 Python | 📅 2026-09-04 - Static analysis tool to automatically deobfuscate strings from malware binaries
...
* [MacOs Collector](https://github.com/LETHAL-FORENSICS/macos-collector) ⭐ 52 | 🐛 0 | 🌐 Shell | 📅 2026-09-01 - Shell script utilized to collect macOS Forensic Artifacts from a compromised macOS endpoint
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,706 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-02 - is an automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
...
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,313 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 - Binwalk is a fast, easy to use tool for analyzing, reverse engineering, and extracting firmware images.
* [Zsteg](https://github.com/zed-0xff/zsteg) ⭐ 1,621 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - A steganographic coder for WAV files
* [Steghide](https://github.com/StefanoDeVuono/steghide) ⭐ 775 | 🐛 4 | 🌐 C++ | 📅 2024-02-20 - is a steganography program that hides data in various kinds of image and audio files
...
* [OSINT](https://github.com/jivoi/awesome-osint) ⭐ 29,160 | 🐛 1 | 📅 2026-09-04
...
* [Social Engineering](https://github.com/v2-dev/awesome-social-engineering) ⭐ 4,254 | 🐛 10 | 📅 2023-04-05
